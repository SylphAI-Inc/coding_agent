---
title: "CrewAI"
description: "Role-based multi-agent framework for building AI teams that collaborate on complex tasks"
---
...
CrewAI models multi-agent systems as teams with roles. You define agents with specific roles (researcher, coder, reviewer), assign them tasks, and CrewAI orchestrates their collaboration — like managing a human team.
...
✅ Want intuitive "team" mental model
