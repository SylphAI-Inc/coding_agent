---
title: "Aider"
description: "AI pair programming in your terminal — the original CLI coding agent"
---
...
Aider is the original AI pair programming tool for the terminal. It pioneered many patterns now standard across coding agents — repo maps, structured edit formats (search/replace, whole-file, unified diff), and multi-model architectures (Architect/Editor mode).

## Key Features

- **Repo map** — Automatic codebase understanding via tree-sitter AST parsing
